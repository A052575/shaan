...
import crop1 from '../assets/crousel-img/crop-1.png';
import regulaterSwitch from '../assets/crousel-img/regulater-swich.png';
import rgb from '../assets/crousel-img/rgb.png';
import ropeLights from '../assets/crousel-img/Rope Lights.png';
import wiresCables from '../assets/crousel-img/Wires-Cables.png';
...
const slides = [
  {
    ...
    description:
      'लिविंग रूम और हॉल को दीजिए एक आलीशान और रोशन अहसास। आकर्षक क्रिस्टल और मेटालिक फिनिश में उपलब्ध।',
    image: crop1,
...

  {
    ...
    description:
      'शॉर्ट सर्किट और ओवरलोड से अपने घर और परिवार को सुरक्षित रखें। 100% शुद्ध कॉपर वायर उचित थोक भाव में।',
    image: wiresCables,
...

  {
    ...
    description:
      'कम बिजली खर्च में तेज व आंखों को सुकून देने वाली नेचुरल रोशनी। 1 से 2 साल की वारंटी के साथ उपलब्ध।',
    image: rgb,
...

  {
    ...
    description:
      'दीवारों की सुंदरता बढ़ाने वाले ग्लॉसी व मैट फिनिश मॉड्यूलर बोर्ड और शॉक-प्रूफ सेफ्टी सॉकेट्स।',
    image: regulaterSwitch,
...

  {
    ...
    description:
      'घर, दुकान या मैरिज हॉल की शानदार सजावट के लिए वेदरप्रूफ और वाइब्रेंट कलरफुल डेकोरेटिव लाइट्स।',
    image: ropeLights,
